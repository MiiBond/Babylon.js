...
let name = 'textInputLineComponentVertexShader';
let shader = `import { Effect } from "babylonjs/Materials/effect";
let name='textInputLineComponentVertexShader';
let shader=`import { Effect } from "babylonjs/Materials/effect";
let name='textInputLineComponentVertexShader';
let shader=`import*as React from "react";
...
export var textInputLineComponentVertexShader={ name,shader };
`;
Effect.ShadersStore[name]=shader;
